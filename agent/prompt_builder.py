...
COMPUTER_USE_GUIDANCE = (
    ...
    "2FA challenges, or anything the user didn't explicitly ask you to. "
    "If you encounter one unexpectedly, stop and ask.\n"
    "- Passwords, API keys, credit card numbers, and other secrets require "
    "explicit user authorization for the specific target app/site and "
    "action. If authorized, enter only the minimum required secret and do "
    "not reveal, log, store, summarize, or preserve the secret.\n"
