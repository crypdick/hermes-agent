...
_SKILL_REVIEW_PROMPT = (
    ...
    "there is a clear procedural lesson about HOW to do a class of task. "
    "Do not treat ordinary information-seeking conversations as skill "
    "signals. A user should be able to chat about random topics without "
    "Hermes turning those topics into skills.\n\n"
    ...
    "Preference order — prefer the earliest action that fits, and do "
    "not force an action when the session was just Q&A or casual chat:\n"
    ...
    "  4. CREATE A NEW CLASS-LEVEL UMBRELLA SKILL only when no "
    "existing skill covers a durable way-of-working pattern. Never "
    "create a skill merely because the user asked for information, "
    "the answer contained useful links, or the topic might be useful "
    "someday. Informational findings belong in the knowledge vault "
    "or normal conversation notes, not the skill library, unless they "
    "support an already-valid procedural skill. The name MUST be at "
    "the class level. "
    ...
    "  • One-off informational Q&A, casual chat, and topic exploration. "
    "If the user asks a factual question, asks for links, or explores a "
    "random topic, do not create a skill for that domain. If the answer "
    "is worth preserving, prefer the user's knowledge vault/conversation "
    "filing path instead of the skill library.\n"
    ...
    "'Nothing to save.' is a real option and is the right answer for "
    "ordinary information-seeking, casual chat, and smooth one-off tasks "
    "with no corrections or new procedural technique. Otherwise, act."
)
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "**Skills**: how to do this class of task. Update skills only when "
    "there is a clear procedural lesson about HOW to do a class of task. "
    "Do not treat ordinary information-seeking conversations as skill "
    "signals. A user should be able to chat about random topics without "
    "Hermes turning those topics into skills.\n\n"
    ...
    "Preference order for skills — pick the earliest that fits, but "
    "do not force a skill update when the session was just Q&A or "
    "casual chat:\n"
    ...
    "  4. CREATE A NEW CLASS-LEVEL UMBRELLA only when no existing "
    "skill covers a durable way-of-working pattern. Never create a "
    "skill merely because the user asked for information, the answer "
    "contained useful links, or the topic might be useful someday. "
    "Informational findings belong in the knowledge vault or normal "
    "conversation notes, not the skill library, unless they support "
    "an already-valid procedural skill. Name at the class level — NOT "
    "a PR number, error string, "
    ...
    "the session was ordinary information-seeking, casual chat, or a "
    "smooth one-off task with no corrections or new procedural technique, "
